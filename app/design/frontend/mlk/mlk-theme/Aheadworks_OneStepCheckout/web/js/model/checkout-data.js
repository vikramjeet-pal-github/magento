...
define(
    ...
    function ($, customerData, checkoutData) {
        ...
        return {
            ...
            setInputFieldPasswordValue: function (password) {
                checkoutData.setInputFieldPasswordValue(password);
            },

            setInputFieldConfirmPasswordValue: function (confirmPassword) {
                checkoutData.setInputFieldPasswordValue(confirmPassword);
            },

            getValidatedPasswordValue: function() {
