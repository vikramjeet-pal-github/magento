...
define(
    ...
    function (Component, $, ko, registry, undefined) {
        ...
        return Component.extend({
            ...
            settings: {}, // NOTE: theme js override added to add this line, and the hasOwnProperty call on line 71, to prevent errors
            ...
            _loadApi: function () {
                ...
                element.src = 'https://www.google.com/recaptcha/api.js'
                    ...
                    + (this.settings.hasOwnProperty('lang') && this.settings.lang ? '&hl=' + this.settings.lang : '');
