...
return [
    'modules' => [
        ...
        'Vendor_Module' => 0,
        'Vonnda_AheadworksRma' => 1,
        'Vonnda_AlternativeOrigin' => 1,
        'Vonnda_DeviceManager' => 1,
        'Vonnda_CheckoutSurvey' => 1,
        'Vonnda_Cognito' => 1,
        'MLK_Core' => 1,
        'Vonnda_GiftOrder' => 1,
        'Vonnda_MedicalFlow' => 1,
        'Vonnda_NarvarShipment' => 1,
        'Vonnda_Netsuite' => 1,
        'Vonnda_Subscription' => 1,
        'Vonnda_Residential' => 1,
        'Vonnda_Checkout' => 1,
        'Vonnda_StripePayments' => 1,
        'Vonnda_ShippingRestrictions' => 1,
        'Vonnda_TealiumTags' => 1,
        'Yereone_NewOrderAttribute' => 1
    ]
];
