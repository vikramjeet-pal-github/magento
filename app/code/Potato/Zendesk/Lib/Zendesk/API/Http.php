...
use Potato\Zendesk\Lib\Zendesk\API\Exceptions\ApiResponseException;
...
class Http
{
    ...
    public static function send(
        ...
        try {
			...
			\Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug('Send Request');
			\Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug($request->getHeaders());
			\Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug($request->getBody());
			...
			if(isset($response)){
				\Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug($response->getStatusCode());
				\Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug($response->getBody());
			}
