 ...
 */
namespace MLK\Core\Block\Sales\Adminhtml\Order\Creditmemo\Create;
...
class Items extends AbstractItems
{
    ...
    /**
     * Prepare child blocks - OVERRIDEN TO ADD CLASS FOR STYLING - ALL OTHER METHODS UNTOUCHED
     *
     * @return $this
     */
        ...
        if ($this->getCreditmemo()->canRefund()) {
            ...
            $this->addChild(
                ...
                [
                    ...
                    'class' => 'save submit-button primary refund-offline-button',
