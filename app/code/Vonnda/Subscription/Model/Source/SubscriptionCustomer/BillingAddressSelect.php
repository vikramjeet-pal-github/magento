...
class BillingAddressSelect implements ArrayInterface
{
    ...
    public function toOptionArray()
    {
        ...
        if($subscriptionCustomerId){
            try {
                ...
                //TODO - need to get addresses that were used for payments but without parentId
                $addresses = $customer->getAddresses();
                $dataArray[] = ['label' => "No address chosen", 'value' => ""];
