...
class BulkAssignShippingMethodOverwrite extends \Magento\Backend\App\Action
{
    /**
    ...
    public function execute()
    {
        try {
            ...
            $resultPage->getConfig()->getTitle()->prepend((__('Bulk Assign Shipping Method Overwrite')));
