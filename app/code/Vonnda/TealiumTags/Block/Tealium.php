...
use Vonnda\TealiumTags\Helper\TealiumData;

class Tealium extends \Tealium\Tags\Block\Tealium
{
    ...
    public function __construct(
        ...
        \Vonnda\TealiumTags\Helper\TealiumData $helper,
        \Magento\Framework\App\Request\Http $request,
        array $data = []
    ) {
        parent::__construct($context, $helper, $request, $data);
    }
    ...
    public function init(
        ...
        $udoElements = [
            ...
            'Checkout' => $tealiumData->getCheckoutData()
        ];
