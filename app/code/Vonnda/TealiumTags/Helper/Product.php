...
class Product extends \Tealium\Tags\Helper\Product
{
    public function getProductData($product_id, $array = true)
    {
        ...
        if ($result['product_list_price'][0] == 0) {
            //Overwrite to add this if check otherwise the following line throws an uncaught exception if the product is not of type Configurable 
