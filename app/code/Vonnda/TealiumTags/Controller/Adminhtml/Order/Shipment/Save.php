 ...
 */
namespace Vonnda\TealiumTags\Controller\Adminhtml\Order\Shipment;

use Vonnda\TealiumTags\Helper\ShipmentHelper;

use Magento\Shipping\Controller\Adminhtml\Order\Shipment\Save as CoreShipmentSave;
use Magento\Sales\Model\Order\Shipment\Validation\QuantityValidator;

/**
 * Class Save - Only modified to fire tealium event
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Save extends CoreShipmentSave
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->shipmentHelper->sendShipmentEvent($shipment);
