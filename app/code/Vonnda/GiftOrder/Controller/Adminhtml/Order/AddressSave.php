...
use Magento\Sales\Controller\Adminhtml\Order\AddressSave as CoreAddressSave;
 ...
 */
class AddressSave extends CoreAddressSave
{
    /**
    ...
    {
        //TODO - ADD E-MAIL FIRE IF CHANGED
        ...
        if ($data && $address->getId()) {
            $giftRecipientHasChanged = $this->giftRecipientEmailHasChanged($data, $address);
            ...
            try {
                ...
                if($giftRecipientHasChanged){
                    $this->resendGiftRecipientEmail($address->getParentId());
                }
    ...
    protected function giftRecipientEmailHasChanged($data, $address)
    {
        if(isset($data['gift_recipient_email']) 
            && ($address->getGiftRecipientEmail() !== $data['gift_recipient_email'])){
                return true;
        }
    ...
    protected function resendGiftRecipientEmail($orderId)
    {
        //TODO - RESEND GIFT RECIPIENT EMAIL
        $this->logger->info('Gift recipient e-mail has changed, resending confirmation.');
    }
}
