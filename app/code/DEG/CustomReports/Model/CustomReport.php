...
class CustomReport extends \Magento\Framework\Model\AbstractModel implements \DEG\CustomReports\Api\Data\CustomReportInterface, \Magento\Framework\DataObject\IdentityInterface
{
     ...
     * @param GenericReportCollectionFactory|null $genericReportCollectionFactory
     * @param array $data
     */
    public function __construct(
        ...
        $this->genericReportCollectionFactory = $genericReportCollectionFactory ?: ObjectManager::getInstance()->get(
            GenericReportCollectionFactory::class
        );
    ...
    public function getGenericReportCollection()
    {
        ...
        $genericReportCollection->getSelect()->from(
            new \Zend_Db_Expr('(' . $this->getData('report_sql') . ')')
        );
