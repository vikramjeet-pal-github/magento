...
class StripeCustomer extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function listUpdateCards($params = array())
    {
        
        try
        {
            return $this->_helper->listUpdateCards($this->_stripeCustomer, $params);
        }
        catch (\Exception $e)
        {
            return null;
    ...
    public function getCustomerupdateCards($customerId = null)
    {
