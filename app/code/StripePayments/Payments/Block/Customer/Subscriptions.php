...
class Subscriptions extends \Magento\Framework\View\Element\Template
{
    ...
    public $CustomerupdateCards = null;
    public $helper;
...
public function getCustomerupdateCards()
    {

        if (isset($this->CustomerupdateCards))
        
            return $this->CustomerupdateCards;

        $this->CustomerupdateCards = $this->stripeCustomer->getCustomerupdateCards();

        if (empty($this->CustomerupdateCards))
            $this->CustomerupdateCards = []; // Set the variable to avoid unnecessary API calls
